...
export function createPreviewActionColumn(
  ...
  return {
    ...
    customRender: ({ record }) => {
      ...
      if (isTinymce) {
        actions.push({
          label: t('component.upload.insertEditor'),
          onClick: handleEditorInsert.bind(null, record),
        });
      }
